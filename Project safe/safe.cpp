...
void thanks() {
//  cout << "\n\n" << CYAN << setw(10) << " " << "████─████─████─████─█──█─████─████────███─████────████──█──█─█──█─█───█─████─█──█─█──█─███" << setw(10) << " " << "\n";
//  cout << setw(10) << " " << "█──█─█──█─█──█─█──█─█──█─█────█──█──────█─█──█────█──██─█──█─█──█─██─██─█──█─█──█─█──█─█──" << setw(10) << " " << "\n";;
//  cout << setw(10) << " " << "█────█──█─████─█────█─██─████─█──█────███─████────████──████─█─██─█─█─█─████─████─█─██─███" << setw(10) << " " << "\n";;
//  cout << setw(10) << " " << "█──█─█──█─█──█─█──█─██─█─█──█─█──█──────█─█──█────█──██─█──█─██─█─█───█─█──█─█──█─██─█─█──" << setw(10) << " " << "\n";;
//  cout << setw(10) << " " << "████─█──█─█──█─████─█──█─████─████────███─█──█────████──█──█─█──█─█───█─█──█─█──█─█──█─███" << setw(10) << " " << ENDC << "\n\n";;
...
int main() {
  ...
  while (true) {
    ...
    if (choice == 1) {
      ...
      int choice1;
      cout << endl << endl << BOLD << "Желаете продолжить ?\n1. Да\n2. Нет\n\nВаш выбор: ";
      cin >> choice1;
      if(choice1 == 1) system("clear");
      else if(choice1 == 2) break;
      else {
      ...
      cout << BOLD << " /‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾\\" << endl;
      cout << "|  Проект на C++                     ==SAFE==     |" << endl;
      cout << "|  Автор: Ягольник Даниил Сергеевич               |" << endl;
      cout << "|  Ученик 11 \"А\" класса МОБУСОШ №24               |" << endl;
      cout << "|  Преподаватель: Григорьева Ирина Витальевна     |" << endl;
